...
function submenu() {
    ...
    if (submenu) submenu.classList.toggle("visa");
}
// LIGA DROPDOWN
...
function ligaDrop() {
  ...
  const ligaDropEl = document.getElementById("liga-dropp");
  const ligaBtn = document.getElementById("ligaBtn");
  if (ligaDropEl) ligaDropEl.classList.toggle("visa");
  if (ligaBtn) ligaBtn.querySelector(".caret")?.classList.toggle("toggle");
