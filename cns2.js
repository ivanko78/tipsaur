...
function initSimpleStickyBanner() {
    ...
    // Provera da li je banner uopšte vidljiv na stranici
    ...
    window.addEventListener('resize', () => {
        // Kada se promeni veličina prozora, ponovo proveravamo da li je banner vidljiv
        if (window.innerWidth >= 800) {
            measureBanners();
            handleScroll();
        } else {
            // Ako smo prešli na mobilni, resetujemo stilove
